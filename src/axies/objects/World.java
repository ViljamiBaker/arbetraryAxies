...
public class World {
    ...
    public static Point[] points = {};//{new Point(1,1,1),new Point(2,2,2),new Point(1,2,1),new Point(2,2,2)};
    ...
    public static MoveableCube[] moveableCubes = {
    ...
    public static Model[] models = {
        new Model(
            new Cube[]{
                ...
                new Cube(new Point(3.9,1,4.0), new Point(0.1,1,1.0,0.5,2),true),
                ...
                new Cube(new Point(2,5,2), new Point(5,1,2,2,2),false),
                new Cube(new Point(2,5,4), new Point(2,1,1,2,2),false),
                new Cube(new Point(5,5,4), new Point(2,1,1,2,2),false),
                new Cube(new Point(2,5,5), new Point(5,1,2,2,2),false),
        
                new Cube(new Point(3,6,3), new Point(3,1,1,2,2),false),
                new Cube(new Point(3,6,4), new Point(1,1,1,2,2),false),
                new Cube(new Point(5,6,4), new Point(1,1,1,2,2),false),
                new Cube(new Point(3,6,5), new Point(3,1,1,2,2),false),
            }, 
            new Point[]{
